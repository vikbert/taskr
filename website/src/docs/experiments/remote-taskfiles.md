...
```text [HTTP/HTTPS]
https://raw.githubusercontent.com/vikbert/taskr/main/website/src/public/Taskfile.yml
```

```text [Git over HTTP]
https://github.com/vikbert/taskr.git//website/src/public/Taskfile.yml?ref=main
```

```text [Git over SSH]
git@github.com/vikbert/taskr.git//website/src/public/Taskfile.yml?ref=main
```
...
```shell [HTTP/HTTPS]
$ task --taskfile https://raw.githubusercontent.com/vikbert/taskr/main/website/src/public/Taskfile.yml
task: [hello] echo "Hello Task!"
Hello Task!
```

```shell [Git over HTTP]
$ task --taskfile https://github.com/vikbert/taskr.git//website/src/public/Taskfile.yml?ref=main
task: [hello] echo "Hello Task!"
Hello Task!
```

```shell [Git over SSH]
$ task --taskfile git@github.com/vikbert/taskr.git//website/src/public/Taskfile.yml?ref=main
task: [hello] echo "Hello Task!"
Hello Task!
```
...
includes:
  my-remote-namespace: https://raw.githubusercontent.com/vikbert/taskr/main/website/src/public/Taskfile.yml
```
...
includes:
  my-remote-namespace: https://github.com/vikbert/taskr.git//website/src/public/Taskfile.yml?ref=main
```
...
includes:
  my-remote-namespace: git@github.com/vikbert/taskr.git//website/src/public/Taskfile.yml?ref=main
```
